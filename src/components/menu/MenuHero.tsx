    ...
    return (
        <div className="relative h-[300px] md:h-[400px]">
            ...
            <div className="absolute top-1 left-0 z-30 container mx-auto px-4 pt-4">
                <Link to="/" className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-md px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-white/30 transition-colors text-white">
