    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col sm:flex-row h-full overflow-hidden">
            <div className="relative w-full sm:w-40 h-56 sm:h-auto flex-shrink-0 bg-gray-50 flex items-center justify-center text-center">
                ...
                {item.isBestseller && (
                    <div className={`absolute top-3 right-3 px-2 py-1 rounded-lg flex items-center gap-1.5 shadow-sm bg-blue-800 text-white`}>
            ...
            <div className="p-4 flex flex-1 flex-col">
                ...
                <div className="mt-auto flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className={`border ${item.isVeg ? 'border-green-600' : 'border-red-500'} rounded-sm w-3.5 h-3.5 flex items-center justify-center`}>
                            <div className={`w-2 h-2 ${item.isVeg ? 'bg-green-600' : 'bg-red-500'} rounded-full`}></div>
                        </div>
