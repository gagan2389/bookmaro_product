                            ...
                            <div>
                                ...
                                >
                                    {[1, 2, 3, 4, 5, 6, 7, 8, '8+'].map(num => (
                                        <option key={num} value={`${num} people`}>{num} people</option>
                                    ))}
                                </select>
                                ...
                                {timeSlots.map((time) => (
                                    <button
                                        ...
                                        className={`py-2 px-3 !rounded-lg border text-sm font-medium transition-all ${selectedTime === time
                                            ...
                                            : 'bg-white border-gray-200 text-gray-700 hover:border-indigo-900/30 hover:bg-indigo-50'} ${errors.selectedTime && !selectedTime ? 'border-red-500' : ''}`}
                                    >
                                        {time}
                                    </button>
                                ))}
